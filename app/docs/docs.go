...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/isn/{isn_slug}/signal-types/{signal_type_slug}/signals/{signal_id}": {
            "get": {
                "tags": [
                    "Signals Management"
                ],
        ...
        "/isn/{isn_slug}/signal-types/{signal_type_slug}/v{version}/signals": {
            "post": {
                "security": [
                    {
                        "BearerAccessToken": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "example": "0.0.1",
                        "description": "signal type version number",
                        "name": "version",
                        "in": "path",
                        "required": true
                    },
